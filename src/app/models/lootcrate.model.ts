...
export class lootCrate {
  constructor(public name: string, public idleAttack: number, public attack: number, public critChance: number, public criticalDamage: number, public goldRate: number) {
    let itemAmount =  4
